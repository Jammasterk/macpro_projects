...
profileRouter.put("/:profileId", (req, res, next) => {
    Profile.findOneAndUpdate(
        ...
        (err, updateProfile) => {
            ...
            return res.status(200).send(`Successfully updated ${updateProfile.name}'s profile`)
        }
    )
})
...
profileRouter.put("/:profileId", (req, res, next) => {
    Profile.findOneAndUpdate(
        ...
        (err, updateProfile) => {
            ...
            return res.status(201).send(`Successfully update ${updateProfile.nickname} profile`)
        }
    )
})
